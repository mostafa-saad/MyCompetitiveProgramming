...
public class Solve_bm {
    ...
    class Tree {
        ...
        Tree(Point[] ptsByX, Point[] ptsByY, boolean splitByY) {
            len = ptsByX.length;
            ...
            if (ptsByX.length <= CNT) {
                ...
                left = new Tree(filter(ptsByX, cmp, splitBy, true, new Point[size]),
                        filter(ptsByY, cmp, splitBy, true, new Point[size]), !splitByY);
                right = new Tree(filter(ptsByX, cmp, splitBy, false, new Point[ptsByX.length - size]),
                        filter(ptsByY, cmp, splitBy, false, new Point[ptsByX.length - size]), !splitByY);
