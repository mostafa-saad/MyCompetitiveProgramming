/*
    ...
    Same as hacs1, but assumes that  we start at computer 1
    (Should pass tests from group 3 only)

    Calculates the maximum protection operator can get assuming hacker starts at comp 1
    and subtracts it from sum of all values.
 */
