 ...
 *                        z powodu u¿ycia zybt ma³o dok³adnej arytmetyki.*
 *                        Z³o¿ono¶æ obliczeniowa wynosi O(n*n), natomiast*
 *                        pamiêciowa O(n). U¿yto arytmetyki              *
 *                        zmiennopozycyjnej typu float.                  *
 *                                                                       *
 *************************************************************************/
...
typedef float typ;              //typ danych zmiennoprzecinowych
