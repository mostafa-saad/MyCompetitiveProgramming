 ...
 *   Opis:     Rozwiazanie niepoprawne zakladajace przemiennosc p i s    *
 *                                                                       *
 *************************************************************************/
...
int f(int px, int kx, int py, int ky, bool tylkoS = false)
{
    ...
    return (tylkoS || f(px, ostatni_x-1, py, ostatni_y-1)) && f(pierwszy_x+1, kx, pierwszy_y+1, ky, true);
}
