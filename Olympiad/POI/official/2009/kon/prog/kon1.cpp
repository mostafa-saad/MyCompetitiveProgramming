 ...
 *   Plik:     kon1.cpp                                                  *
 *   Autor:    Pawel Parys                                               *
 *   Opis:     Rozwiazanie prawie wzorcowe O(n^2*k)                      *
 *             For chodzi po calym zakresie a nie tam gdzie to ma sens.  *
 *                                                                       *
 *************************************************************************/
...
unsigned int prost[1010][1010]; // ilu wsiadlo na >=a i wysiadlo <=b
unsigned int best[1010][1010]; // best[o][k] = ilu pasazerow co najmniej trzeba pominac
...
int main()
{
  ...
  unsigned int best_gl = 2000000001;
  int ost = -1;
  FOR(o, 0, N-2)
