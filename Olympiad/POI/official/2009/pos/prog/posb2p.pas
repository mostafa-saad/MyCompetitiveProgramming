 ...
 *   Opis:     Rozwiazanie praiwe wzorcowe O(max(a,b)*log n), ktore      *
 *             nie sprawdza czy poprawilo sie oszacowanie pesymistycznego*
 *             kosztu.                                                   *
 *                                                                       *
 *************************************************************************)
...
BEGIN
  ...
  step := 1;
	...
	// Szuka Bajtyny
	while l < r do begin
		// Po odpowiedzi Bitocego moglo sie poprawic szacowanie - blad ze program tego nie robi
