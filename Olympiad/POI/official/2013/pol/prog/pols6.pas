...
var
    n, i, kandydat : longint;
    wynik, najlepszy, h : int64;
    (* sz - wielkosc poddrzewa *)
    sz : array[1..MAX_N] of longint; 
    (* wielkosci poddrzew synow kandydata*)
...
(* Rozwiazuje problem plecakowy.
    ...
    suma wielkosci poddrzew pewnych synow kandydatu
...
begin
    ...
    begin
        ...
        lb_synow := 0;
        for i := kr_pocz[kandydat] to kr_kon[kandydat] do
        begin
            Inc(lb_synow);
        ...
        if(najlepszy < wynik) then najlepszy := wynik;
    end;

    writeln(n - 1, ' ', najlepszy);
