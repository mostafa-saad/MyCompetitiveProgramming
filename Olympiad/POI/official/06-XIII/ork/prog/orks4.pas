...
procedure licz;
var
  wynik, i, lewe_ciecia, prawe_ciecia : longint;
begin
  wynik := INF;
  ...
  begin
    ...
    for lewe_ciecia := 0 to m - 1 do
      for prawe_ciecia := 0 to m - lewe_ciecia - 1 do
        if (n + lewe_ciecia + prawe_ciecia < wynik) and (mozna_zaorac(lewe_ciecia, prawe_ciecia)) then
