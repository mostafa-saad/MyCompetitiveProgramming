 ...
 *   Zlozonosc czasowa:    O(d^(2n)), gdzie d to maksymalny stopien      *
 *   Opis:                 Rozwiazanie powolne, wczytujemy drzewo i      *
 *                         generujemy tylko sciezki, spelniajace         *
 *                         ograniczenie odleglosciowe; konczymy, jesli   *
 *                         uzyskamy dlugosc n, o poczatku 1 i koncu n    *
 *                                                                       *
 *************************************************************************/
...
class PathSearchNoCutoff: public PathSearch<char> {
public:
    PathSearchNoCutoff(const Tree &g): PathSearch<char>(g) {}
