 ...
 *   Opis:                                                               *
 *                                                                       *
 *  Interaktywny program oceniajacy do zadania Konewka                   *
 *                                                                       *
 ...
 *                                                                       *
 *  Nastepnie czyta q wierszy, w ktorych znajduja sie                    *
 *  instrukcje postaci:                                                  *
 *    "p a b" (reprezentujaca wykonanie funkcji "podlej(a,b)")           *
 *    "d a b" (reprezentujaca wykonanie funkcji "dojrzale(a,b)")         *
 *                                                                       *
 *  Program wywoluje odpowiednie funkcje ocenianej biblioteki            *
 *  i wypisuje wyniki funkcji "dojrzale" na standardowe wyjscie          *
 *                                                                       *
 *************************************************************************/
