...
int where[MAXN+7]; // na jakiej pozycji na stosie znajduje sie dany wierzcholek, -1 jesli nie ma
int res; // wynik
bool vis[MAXN+7]; // tablica odwiedzonych wierzcholkow dla DFSa
