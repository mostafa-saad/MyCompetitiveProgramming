 ...
 *   Opis:              Rozwiazanie powolne, wzorcowka bez rozszerzonego *
 *                      algorytmu Euklidesa                              *
 *                                                                       *
 *************************************************************************/
...
void no_euclid(ll a, ll b, ll& x, ll& y) {
   for (ll xi = 0; xi <= bound; ++xi) {
      if ( (1-a*xi) % b == 0 ) { x = xi; y = (1-a*xi)/b; return; }
      else if ( (1-a*(-xi)) % b == 0) { x = -xi; y = (1-a*(-xi))/b; return; }
   }
}
