 ...
 *                      Wariacja na temat algorytmu Dijstry: wierzcholek *
 *                      moze byc odwiedzany wielokrotnie                 *
 *                                                                       *
 *************************************************************************/
...
void compute_lp(){
    ...
    REP(i, n) {
        ...
        while(! Q.empty()){
            PII tmp = Q.top(); Q.pop();
            int current = tmp.ND;
            if ( LP[i][current] >= tmp.ST ) continue;
            LP[i][current] = tmp.ST;
            
            FE(v, G[current]) {
                if ( M[current][*v] > -INF && LP[i][current] + M[current][*v] > LP[i][*v] ) {
