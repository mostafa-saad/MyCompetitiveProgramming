 ...
 *   Zlozonosc czasowa: O(k*lg(m) + n*OT*lg(m))                          *
 *                      (OT - wielkość sprawdzanego otoczenia)           *
 *   Opis:              Rozwiazanie bledne: statyczne odgadniecie        *
 *                      odpowiedzi dla panstw, nastepnie silowe          *
 *                      sprawdzenie bliskich momentow                    *
 *                                                                       *
 *************************************************************************/
