 ...
 *   Opis:              Rozwiazanie powolne. Program brute-force.        *
 *   Zlozonosc czasowa: wykladnicza                                      *
 *                                                                       *
 *************************************************************************)
...
var ret, i : LongInt;
begin
    if kon - pocz <= 1 then licz := 1
    else if kon - pocz = 2 then licz := sprawdzKrawedz(pocz, kon)*sprawdz(pocz, pocz+1, kon)
    else
    begin
        ret := 0;
