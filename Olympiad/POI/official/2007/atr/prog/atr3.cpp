...
{*   Opis:    Rozwiazanie wzorcowe O(k*(m+n)*log(n) + k^2*2^k), z        *}
{*            generatorem wszystkich podzbiorow w czasie O(n logn) i     *}
{*            algorytmem Dijkstry z uzyciem kontenera priority_queue     *}
{*            jako kolejki                                               *}
{*                                                                       *}
{*************************************************************************/
#include <algorithm>
