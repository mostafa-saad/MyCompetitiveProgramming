...
var n, m, k : LongInt;
    ...
    naPrzekatnej : array [0..MAXN, 0..MAXN] of Boolean; (* czy jakas owca znajduje sie na przekatnej *)
...
begin
    ...
    for i := 0 to n-1 do
        for j := i + 1 to n do
        begin
            naPrzekatnej[i][j] := (sprawdzKrawedz(i, j) = 0);
            naPrzekatnej[j][i] := naPrzekatnej[i][j];
        end;
