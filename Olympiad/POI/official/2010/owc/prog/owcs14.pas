 ...
 *                      Rozwiazanie ze spamietywaniem liczb Catalana.    *
...
var n, m, k : LongInt;
    ...
    f : array [0..MAXN, 0..MAXN] of LongInt; (* [i][j] -> ile owiec w wielokacie i, i+1, ..., j *)
    ...
    c : array[0..MAXN] of LongInt; (* liczba catalana modulo m *)
...
var ret, i : LongInt;
begin
    if f[pocz][kon] = 0 then licz := c[kon-pocz-1]
    else if kon - pocz <= 2 then licz := 1
    else
    begin
